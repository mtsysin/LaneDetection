...
- Credit: Pume Tuchinda for the control flow of FPN architecture (PANet is an augmentation of FPN)
...
class PANet(nn.Module):
    ...
    def forward(self, c3, c4, c5):
        ...
        '''
        p5 = self.conv_p5(c5)
        m4 = torch.cat((self.upsample(p5), c4), dim=1)
        m4 = self.conv_m4(m4)

        p4 = self.conv_p4(m4)
        m3 = torch.cat((self.upsample(p4), c3), dim=1)
        _n3 = self.conv_m3(m3)
